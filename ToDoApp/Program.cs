...
namespace TodoList
{
    class Program
    {
        ...
        public class MetodosBD
        {
            ...
            {
                const string Url = "http://todoaplicacao.000webhostapp.com/phps/registerUser.php";
            ...
            {
                const string Url = "http://todoaplicacao.000webhostapp.com/phps/loginUser.php";
                HttpClient httpClient = new HttpClient();
            ...
            public async Task<string> UserID(string username) {
                const string Url = "http://todoaplicacao.000webhostapp.com/phps/getUsers.php";
                HttpClient httpclient = new HttpClient();
            ...
            public async Task<string> Tarefas(string userID) {
                const string Url = "http://todoaplicacao.000webhostapp.com/phps/getTarefas.php";
                HttpClient httpclient = new HttpClient();
            ...
            public async Task<string> criarTarefa(string userID, string titulo, string data, string descricao) {
                const string Url = "http://todoaplicacao.000webhostapp.com/phps/criarTarefa.php";
                HttpClient httpclient = new HttpClient();
            ...
            {
                const string Url = "http://todoaplicacao.000webhostapp.com/phps/apagarTarefa.php";
                HttpClient httpclient = new HttpClient();
            ...
            {
                const string Url = "http://todoaplicacao.000webhostapp.com/phps/editarTarefa.php";
                HttpClient httpclient = new HttpClient();
        ...
        static void Main(string[] args)
        {
            ...
            while (loopPrimario)
            {
                ...
                Console.Write("## ");
                int escolhaMenuInicial = Int32.Parse(Console.ReadLine());
                    ...
                    case 1:
                        ...
                        if (resposta.Result == "true") {
                            ...
                            while (loopLogin)
                            {
                                ...
                                Console.Write("## ");
                                int escolhaMenuAcoes = Int32.Parse(Console.ReadLine());
                                switch (escolhaMenuAcoes)
                                {
                                    case 1:
                                        MA.Banner();
